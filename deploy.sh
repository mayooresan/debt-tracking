...
echo -e "Container Name:        ${BOLD}debt-planner${NC}"
...
echo -e "   ${COMPOSE_CMD} logs -f debt-planner"
echo -e "3. Verify container internal health:"
echo -e "   docker exec debt-planner wget -qO- http://localhost:3000/api/auth/status"
